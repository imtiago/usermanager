			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"usermanager-display": {
								"semanticObject": "usermanager",
								"action": "display",
								"description": "app using SAP UI5",
								"title": "User Manager",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=usermanager",
									"url": sap.ui.require.toUrl("usermanager")
								}
							}
						}
					}
